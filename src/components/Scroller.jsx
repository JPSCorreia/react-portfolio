...
const Scroller = () => {
  return (
    ...
    <div className='flex justify-start py-1 items-center'>
      <div className='rounded-full bg-[#ffffff]  shadow-[#67E8F9]  p-2 m-2 cursor-pointer hover:scale-110 hover:text-[#67E8F9] ease-in duration-100'>
        <FaLinkedinIn size={24} color={'#121212'}/>
      </div>
      <div className='rounded-full bg-[#ffffff]  shadow-[#67E8F9] p-2 m-2 cursor-pointer hover:scale-110 hover:text-[#67E8F9] ease-in duration-100'>
        <FaGithub size={24} color={'#121212'}/>
      </div>
      <div className='rounded-full bg-[#ffffff] color-[#121212] shadow-[#67E8F9] p-2 m-2 cursor-pointer hover:scale-110 hover:text-[#67E8F9] ease-in duration-100'>

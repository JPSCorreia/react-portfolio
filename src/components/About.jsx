...
const About = () => {
  ...
  return (
    <div
      id="about"
      className="w-[90%] m-auto md:h-screen p-2 flex items-center pt-20 pb-24 md:pt-16 mt-32"
    >
      <div
      ...
      >
        <div className="flex flex-col ">
          ...
          <div className="flex flex-row">
            ...
            >
              <img
                className="animated-image w-[160px] block sm:hidden rounded-full ring-2 ring-[#67E8F9]/20 shadow-lg shadow-[#ffffff] hover:shadow-[#67E8F9] mx-auto mb-8 hover:scale-110 ease-in duration-200 justify-center items-center "
                src={profile}
                alt="/"
              />
